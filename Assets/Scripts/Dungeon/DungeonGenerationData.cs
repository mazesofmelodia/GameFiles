...
public class DungeonGenerationData : ScriptableObject
{
    ...
    public GameObject startRoom;                //Start Room
    public GameObject endRoom;                  //End room
    public GameObject treasureRoom;             //Treasure room
    public GameObject shopRoom;                 //Shop room
